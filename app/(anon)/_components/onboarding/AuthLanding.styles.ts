export const styles = {
  ...
  titleArea: "mb-8 text-center",
  
  logoImg: "mx-auto",
  
  btns: "flex flex-col gap-4",
  
  primary: "w-full py-3 rounded-2xl text-base font-medium flex items-center justify-center bg-brand text-white",
